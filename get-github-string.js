...
let languageList = {
    ...
    1: {
        Shell: ["sh", "bash", "bats", "cgi", "trigger", "tmux"],
        Batch: ["bat", "cmd"],
        COBOL: ["cbl", "cob"],
        "C#": ["cs"],
    ...
    4: {
        ...
        Markdown: ["md", "markdown", "livemd", "workbook"],
        ...
        TOML: ["toml"],
        YAML: ["yaml", "yml"],
        XML: ["xml", "xsd", "xsl", "xslt", "plist", "resx", "rdf", "res", "gpx", "gml", "tml", "ux", "ui", "vbproj", "xaml", "xmi", "xmp", "xproj", "fxml"],
        "Plain Text": ["txt", "fr", "nb", "ncl", ""]
    },
};
